...
| <center>**Multirank Support**</center> | <center>`pair_nequip`: Multirank via the [`pair_nequip_multirank` target](multirank.md), otherwise single rank<br>`pair_allegro`: Multirank</center> | <center>Multirank </center> |
